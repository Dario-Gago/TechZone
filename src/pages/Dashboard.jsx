                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                              <button
                                ...
                                className="px-4 py-2 text-gray-600 bg-gray-100 rounded-md hover:bg-gray-200 transition-colors flex items-center space-x-2"
                              >
                                <X className="w-4 h-4" />
                                <span>Cancelar</span>
                              </button>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-red-600">{product.brand}</p>
                      </div>
                    </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          ...
          {thisMonthPurchases.length > 0 ? (
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p>No tienes compras este mes</p>
            </div>
          )}
        </div>
      </div>
